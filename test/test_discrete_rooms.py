...
class TestDiscreteXuFourRooms:
    ...
    def test_is_terminal(self):
        assert not self.env.is_state_terminal((4, 2))
        assert self.env.is_state_terminal((10, 10))

    def test_state_space(self):
        assert len(self.env.state_space) == 104
        # 11x11 grid with 17 walls = 104 states
